  ...
  return (
    ...
    >
      ...
      <div className="flex flex-cols-2 justify-between items-center mt-auto">
        ...
        <button className="flex items-center justify-center border border-solid rounded-[9.83px] w-[36px] h-[36px] relative bg-white transition-all duration-200 ease-in-out hover:shadow-[2px_2px_0px_rgba(0,0,0,0.2)]">
